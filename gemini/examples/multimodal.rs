...
async fn raw_multimodal() {
    ...
    session.ask(vec!["Where is there in this pdf".into(), InlineData::from_url("https://bitmesra.ac.in/UploadedDocuments/admingo/files/221225_List%20of%20Holiday_2026_26.pdf").await.unwrap().into()]);
